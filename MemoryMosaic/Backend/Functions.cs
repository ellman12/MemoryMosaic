...
public static class Functions
{
	...
	public static string ServerIP
	{
		get
		{
			string jsonPath = P.Combine(Environment.CurrentDirectory, "Properties", "launchSettings.json");
			dynamic json = JsonConvert.DeserializeObject(File.ReadAllText(jsonPath)) ?? throw new NullReferenceException();
			return json.profiles.MemoryMosaic.applicationUrl;
		}
	}
}